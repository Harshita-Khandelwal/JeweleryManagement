...
<link href="<%=request.getContextPath()%>/css/custom/timeline.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/css/custom/sb-admin-2.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/css/jquery/jquery-ui.min.css" rel="stylesheet">
...
<script src="<%=request.getContextPath()%>/js/custom/sb-admin-2.js"></script>
