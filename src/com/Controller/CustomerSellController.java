...
{
	ModelAndView modelAndView = new ModelAndView("customerSellingPage");
		if(session!=null)
...
@RequestMapping(value="addCustomerSell",method=RequestMethod.POST)
	public ModelAndView addCustomerSell(@ModelAttribute("customerSellModel") CustomerSellModel customerSellModel,HttpSession session)
	{
		ModelAndView modelAndView =new ModelAndView("customerSellingPage");
